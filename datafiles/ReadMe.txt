A Tobikomi game where you control a dragon
[Default Controls]
...
Resolution: You can manually set the game's resolution in settings.ini. It was designed to run at the original arcade vertical resolution of 256x224 but also looks fine at 2x or custom resolutions. Game will keep aspect ratio. If you enable fullscreen, resolution will be ignored and instead run at computer's fullscreen mode.